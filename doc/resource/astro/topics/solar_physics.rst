...
-  ```SolarSoftWare``
   (``SSW``) <https://sohowww.nascom.nasa.gov/solarsoft/>`__
...
-  ```irispy`` - A SunPy-affiliated package which provides tools to
   analyze data from IRIS <https://github.com/sunpy/irispy>`__
...
-  ```dkist`` - A Python library for obtaining, processing and
   interacting with calibrated DKIST
   data <https://github.com/DKISTDC/dkist>`__
...
-  ```CHIANTI`` - An Atomic Database for Spectroscopic Diagnostics of
   ...
   -  ```ChiantiPy`` - the Python interface to the CHIANTI atomic
      database for astrophysical
